...
#from azure.identity import AccountKeyCredential
#from azure.storage.common.credentials import AccountKeyCredential
from azure.storage.blob import BlobServiceClient #BlobClient, ContainerClient
import os
from BlobTrigger_B2BIngestion.OedpExceptions import OedpCustomException
from BlobTrigger_B2BIngestion.OedpIO import OedpReader, OedpWriter
...
class OedpAzureReader(OedpReader):
    ...
    def read(self, input_container, input_file_name):
        ...
        """
        try:
        # Split the input blob by slash and take the last element as the blob name
            #blob_name = input_file_name.split("/")[-1]
    ...
    def read_binary(self, input_container, input_blob):
        ...
        """        
        try:
        # Split the blob by slash and take the last element as the blob name
            #blob_name = input_blob.split("/")[-1]
        # Get a BlobClient object to access the blob
    ...
    *****************************************************
    ...
    def delete_object(self, input_container, input_blob):
        ...
        try:
            ...
            # container_client = self.blob_service_client.get_container_client(input_container)
