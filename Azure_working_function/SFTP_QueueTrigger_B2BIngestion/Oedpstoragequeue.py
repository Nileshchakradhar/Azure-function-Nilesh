...
class OedpStorageQueueIO(ABC):
    ...
    def delete_object(self, message_id, pop_receipt):  #message_id message
        """
        ...
        """
        try:
            res = self.queue_client.delete_message(message_id, pop_receipt)   #message_id message
            return res
        except Exception as e:
            raise OedpCustomException(f'Technical: Storage Queue delete object error for message id: {message_id}. {e}')
