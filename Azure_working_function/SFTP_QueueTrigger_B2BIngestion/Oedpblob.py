...
import os
from SFTP_QueueTrigger_B2BIngestion.OedpExceptions import OedpCustomException
from SFTP_QueueTrigger_B2BIngestion.OedpIO import OedpReader, OedpWriter
    ...
    output_container, output_blob):
        ...
        try:
            ...
            raise Exception(f'Technical: Error moving {input_container}/{input_blob} to '
                                  f'{output_container}/{output_blob}. {e}')
